...
TEST_F(Any, SBOInPlaceTypeDynConstruction) {
    entt::any any{entt::in_place_type<int>, 42};
...
TEST_F(Any, NoSBOInPlaceTypeDynConstruction) {
...
TEST_F(Any, RefInPlaceTypeDynConstruction) {
    int value = 42;
...
TEST_F(Any, VoidInPlaceTypeDynConstruction) {
